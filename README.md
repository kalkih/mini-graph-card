...
| grid_line_type | `hour` | `5minute` / `hour` / `day` / `week` | Show grid lines in function of hours_to_show value.
| grid_line_frequency | 2 |  | Grid lines: thin / thick lines amount ratio.
